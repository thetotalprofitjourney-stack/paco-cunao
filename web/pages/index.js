...
export default function Home() {
  ...
  if (success) {
    const whatsappNumber = (process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || '+34XXXXXXXXX').replace(/\D/g, '');
    const whatsappMessage = encodeURIComponent('Hola Paco, ¿en qué puedo ayudarte?');
        ...
        <main className={styles.main}>
          <div className={styles.success}>
            ...
            <div className={styles.highlight}>
              <p>Pulsa el botón para abrir WhatsApp y empezar a jugar:</p>
              <a
                href={whatsappUrl}
